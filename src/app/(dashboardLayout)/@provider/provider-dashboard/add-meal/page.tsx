...
import AddMealForm from "@/components/modules/dashboard/provider/AddMealFrom";
    ...
    <>
      {hasProfile ? (
        ...
        <section className="min-h-[70vh] w-full flex items-center justify-center px-6 py-16">
          <div className="w-full max-w-2xl rounded-[28px] border border-[#e8a030]/15 bg-[linear-gradient(180deg,rgba(200,80,10,0.10)_0%,rgba(232,160,48,0.05)_100%)] backdrop-blur-md shadow-[0_20px_60px_rgba(0,0,0,0.35)] px-8 py-12 text-center">
